...
> 状态：本文 §1-§25 的基线已于 2026-07-13 部署到腾讯云生产环境，§26 对话结果图编辑（原随 `v0.2.1` 发布）已随 `v0.2.7` 于 2026-07-25 在生产上线，当前生产版本为 `0.2.7`。证据见 [PROGRESS.md](PROGRESS.md)。本文件是当前 v2 的**完整产品规格**，后续只在出现新增需求时继续修订。
