...
- 当前工作分支：`codex/user-api-key-modes`，本地功能提交 `0d48d90`，完整本地生成链路修复提交 `1fd083c`。
...
- 本地验证基线：单元测试 187/187、金额测试 74/74、类型检查、构建、敏感信息扫描、Playwright 6 通过 / 1 个旧 smoke 安全跳过。手工生图只用 `npm run dev:netlify:test`；`dev:ui:test` 仅供 mock E2E。
